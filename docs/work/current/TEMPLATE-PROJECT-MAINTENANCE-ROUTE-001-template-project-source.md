...
be315eec10030b3d4499a05b823739a2631cb897
...
Keep developer-owned architecture records accurate when the independent Project
package adds a focused template-maintenance Source, without duplicating its exact
...
- Three current developer architecture records say the independent Project has
  exactly seven Sources.
...
The developer architecture should describe the routing boundary while linking
exact inventory authority to the independent branch, avoiding future count drift.
