...
- Reusable-template structure—configuration, agent/skill instructions, template architecture, and template-owned file/document layout—belongs to Template Maintainer; Developer reports template-level concerns to the orchestrator instead of changing that structure during project work.
