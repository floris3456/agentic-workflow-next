...
Use whenever exact repository evidence is needed in MCP-OFF mode.

## Procedure

1. Navigate manually to `https://github.com/<owner>/<repository>`.
2. Establish branch/ref and exact commit before relying on content.
