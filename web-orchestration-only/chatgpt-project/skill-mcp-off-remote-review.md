# MCP-OFF remote review

## Trigger

Use when visible implementation must be reviewed without MCP connectors.

## Procedure

1. Establish exact base and head SHAs through public GitHub.
2. Review the complete range, not only the final snapshot.
3. Inspect changed files and required context through public pages or raw endpoints.
